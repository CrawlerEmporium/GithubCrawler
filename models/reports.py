...
class Report:
    ...
    async def setup_message(self, bot, guildID, trackerChannel):
        ...
        if not self.is_bug:
            ...
            view.add_item(Button(label=SUBSCRIBE, style=ButtonStyle.blurple, emoji="📢", row=1))
            view.add_item(Button(label=INFORMATION, style=ButtonStyle.blurple, emoji="ℹ️", row=1))
            ...
            view.add_item(Button(label=SUBSCRIBE, style=ButtonStyle.blurple, emoji="📢", row=0))
            view.add_item(Button(label=INFORMATION, style=ButtonStyle.blurple, emoji="ℹ️", row=0))
