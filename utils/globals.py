...
BUG_LISTEN_CHANS = [
    ...
    {
        "id": 708416309641084998,
        "identifier": "FMPBUG",
        "repo": "FantasyModuleParser/FantasyModuleParser"
    }
]
...
def getServer(repo):
    if repo == "flapkan/mpmb-tracker":
        return "MPMB"
    if repo == "FantasyModuleParser/FantasyModuleParser":
        return "Fantasy Module Parser"
...
def getAllServers():
    return ['MPMB','5eTools','Crawlers','Unknown', 'Fantasy Module Parser']
